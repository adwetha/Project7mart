...
public static final String HELMETIMAGE=System.getProperty("user.dir")+"\\src\\test\\resources\\helmet.jpg";
...
public static final String ErrorAdminUserLock="User is not able to click lock";
